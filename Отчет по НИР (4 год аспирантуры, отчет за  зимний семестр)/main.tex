...
\documentclass[12pt,a4paper, onecolumn]{disser}
...
\include{first_page_var2}
\include{abstract}
\include{introdaction}
%\include{content_rus_Jan2016-Sep2017}
\include{content_rus_Sep2017-Jan2018}
%\include{content_rus_winter}
%\include{double_scattering}
%\include{content_eng}
\include{conclusions}
...
\bibliography{mybib}% list here all the bibliographies that you need.

\include{appendix1}
\include{appendix2}
%\include{appendix_reductions}
\end{document}
